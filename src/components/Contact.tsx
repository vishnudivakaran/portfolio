...
export default function Contact() {
  return (
    <section className="mt-24 pb-8 px-[5%] max-w-[1400px] mx-auto" id="contact">
      <motion.div
        initial={{ opacity: 0, y: 40 }}
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.6 }}
        className="glass border-glass-border backdrop-blur-xs rounded-[32px] py-20 px-8 text-center flex flex-col items-center mb-16"
      >
        ...
        <p className="text-neutral-400 mb-12 text-[1.1rem]">Currently open to new opportunities.</p>
